...
public class BlockProcess : MonoBehaviour
{
	...
	[SerializeField] 
	private GameObject _moveBlockObject = default;
	[SerializeField] 
	private GameObject _staticBlockObject = default;
    #endregion
	...
	public void CreateMoveBlock()
    {
		...
		Instantiate(_moveBlockObject, new Vector2(_randomCol, -_randomRow), Quaternion.identity, _rootObject.transform);
	...
	public void CreateStage()
    {
		...
		for (int i = 0; i < SET_STATICBLOCK_COUNT; i++)
		{
			...
			Instantiate(_staticBlockObject, new Vector2(_randomCol, -_randomRow), Quaternion.identity, _rootObject.transform);
		}
